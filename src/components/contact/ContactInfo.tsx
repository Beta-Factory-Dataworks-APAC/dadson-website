    ...
    <div className="flex flex-col h-full">
      <div className="mb-8 md:mb-12 lg:mb-16">
        <div className="flex items-center gap-2 mb-2 md:mb-3">
          ...
          <span className="text-[16px] md:text-[18px] font-satoshi font-medium text-[#00B4E1]">Contact us</span>
        </div>
        <div>
          <div className="text-[28px] sm:text-[36px] md:text-[48px] lg:text-[60px] xl:text-[80px] font-clash font-semibold leading-[1.125] uppercase">
      ...
      <div className="mt-auto">
        <div className="flex flex-col md:flex-row md:gap-[32px] md:items-center">
          <div className="space-y-1 md:space-y-2 mb-4 md:mb-0 flex-1">
            <h4 className="text-[16px] md:text-[18px] font-satoshi font-medium text-[#B3B0BE]">Email us at</h4>
            <div className="flex items-center">
              <a 
                href="mailto:support@dadson.us" 
                className="text-[16px] md:text-[18px] font-satoshi font-medium text-[#101B21] hover:text-[#00B4E1] transition-colors flex items-center"
              >
                support@dadson.us
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-2 w-5 h-5 md:w-6 md:h-6">
          ...
          <div className="w-px h-12 md:h-16 hidden md:block bg-[#E3E3E3]" />

          <div className="space-y-1 md:space-y-2 flex-1">
            <h4 className="text-[16px] md:text-[18px] font-satoshi font-medium text-[#B3B0BE]">Call us at</h4>
            <div className="flex items-center">
              <a 
        ...
        <div className="w-full h-px bg-[#E3E3E3] my-4 md:my-5" />

        <div className="space-y-1 md:space-y-2">
          <h4 className="text-[16px] md:text-[18px] font-satoshi font-medium text-[#B3B0BE]">Address</h4>
          <div>
            <p className="text-[16px] md:text-[18px] font-satoshi font-medium text-[#101B21] leading-[1.33]">
              Dadson Logistics <br />
