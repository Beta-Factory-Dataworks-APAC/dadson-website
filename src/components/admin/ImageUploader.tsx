    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          onClick={() => {
            const stockImages = [
              'https://images.unsplash.com/photo-1566746064867-27d21b74b4dc', // Logistics truck
              'https://images.unsplash.com/photo-1494412519320-aa613df615a2', // Supply chain
              'https://images.unsplash.com/photo-1623000751975-571d6e8abfcf', // Warehouse
              'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088', // Container port
              'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d', // Delivery truck
            ];
      ...
      <div className="text-sm text-gray-500">
        ...
        <ul className="list-disc list-inside mt-1 space-y-1">
          ...
          <li><strong>Stock Photo:</strong> Get a random logistics-related image</li>
        </ul>
      </div>
    </div>
  );
