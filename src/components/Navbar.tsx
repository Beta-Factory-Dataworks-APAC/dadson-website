...
const Navbar = () => {
  ...
  const isActive = (path: string): boolean => {
    // Don't highlight any nav item on the contact page
    ...
    // Highlight the current page for other pages
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:block">
            <Link 
              href="/contact" 
              className={`${contactButtonBaseClasses} ${
                pathname === '/contact'
                  ? activeContactButtonClasses
                  : inactiveContactButtonClasses
              }`}
            >
              CONTACT US
            </Link>
