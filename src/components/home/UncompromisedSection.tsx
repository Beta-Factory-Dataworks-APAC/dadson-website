  ...
  return (
    <section className="py-[10px] sm:py-[20px] md:py-[40px] lg:py-[80px] px-4 md:px-6 bg-white">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-3 sm:gap-6 md:gap-8 lg:gap-16">
        ...
        <div className="w-full md:w-[40%] flex flex-col justify-start mb-3 sm:mb-6 md:mb-0">
          ...
          <div className="w-full md:w-[90%] text-cyan-500 font-clash uppercase relative pb-[20%] sm:pb-[22%] md:pb-0">
            <Image 
