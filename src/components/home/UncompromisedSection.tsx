...
const UncompromisedSection = () => {
  return (
    <section className="py-[12px] sm:py-[20px] md:py-[40px] lg:py-[80px] px-4 md:px-6 bg-white">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 lg:gap-16">
        ...
        <div className="w-full md:w-[60%] flex flex-col justify-center">
          <div className="self-stretch text-slate-800 text-[18px] sm:text-[20px] md:text-[24px] font-satoshi font-medium leading-loose mb-2 sm:mb-3 md:mb-4">
