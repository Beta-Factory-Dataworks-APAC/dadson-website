...
const HeroSection = () => {
  return (
    <div className="mx-[5px] md:mx-[20px] mb-[15px] relative">
      <section className="relative w-full h-[500px] sm:h-[550px] md:h-[640px] lg:h-[1040px] overflow-hidden rounded-[12px] md:rounded-[20px] mt-[10px]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-start w-full h-full px-4 md:px-6 text-white text-center pt-[80px] sm:pt-[95px] md:pt-[150px] pb-[25px] sm:pb-[40px] md:pb-[60px]">
          {/* Main headline - moved down for mobile */}
          <h1 className="font-clash font-medium text-[26px] sm:text-[40px] md:text-[60px] lg:text-[80px] leading-[1.15] sm:leading-[1.2] md:leading-[90px] uppercase text-center max-w-full md:max-w-[1224px] mx-auto mb-[10px] mt-[30px] sm:mt-[25px] sm:mb-[25px] md:mb-[40px] transform rotate-[0.65deg]">
            Trusted Freight Solutions.<br />
            Backed by Real People.
          </h1>

          {/* Empty spacer - adjusted for mobile visibility */}
          <div className="flex-grow min-h-[20px] sm:min-h-[50px] md:min-h-[100px]"></div>
